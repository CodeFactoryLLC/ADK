...
{
    /// <summary>
    /// Contract definition for generating syntax from a member model to be added to a target container.
    /// </summary>
    /// <typeparam name="TContainerType">The type of <see cref="CsContainer"/> to be injected into.</typeparam>
    /// <typeparam name="TMemberType">The <see cref="CsMember"/> model used to build the injected syntax.</typeparam>
    public interface IInjectContainerMemberSyntax<TContainerType, TMemberType> where TContainerType: CsContainer where TMemberType : CsMember
    {
        /// <summary>
        /// Generates syntax to be injected into the target source.
        /// </summary>
        /// <param name="updateSource">The source and container to be updated.</param>
        ...
        Task<IUpdateSource<TContainerType>> InjectSyntaxAsync(IUpdateSource<TContainerType> updateSource,
