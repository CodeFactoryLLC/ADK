...
{
    /// <summary>
    /// Tracks updates for a target class and the source for that class.
    /// </summary>
    public class UpdateClassSource:UpdateSourceBase<CsClass>,IUpdateInstanceSource<CsClass>
    {
        /// <summary>
        /// Creates an instance of <see cref="UpdateClassSource"/>
        /// </summary>
        /// <param name="source">The source code file to update.</param>
        /// <param name="container">The class model that is to be updated.</param>
        ...
        public UpdateClassSource(CsSource source, CsClass container, IVsActions vsActions, NamespaceManager namespaceManager) : base(source, container, vsActions, namespaceManager)
        {
            //Intentionally blank
        }
