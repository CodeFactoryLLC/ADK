...
{
    public class StringBoundsCheck:BoundsCheckBase
    {
        /// <summary>
        ...
        public StringBoundsCheck(ILoggingFormatter loggingFormatter = null) : base("StandardStringBoundsCheck", true,loggingFormatter)
        {
            //Intentionally blank.
        }
