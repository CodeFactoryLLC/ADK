...
namespace CodeFactory.ADK.NDF
{
    public class CatchBlockException:CodeBlockSyntaxBase
    {
        ...
        public override string GenerateSyntax()
        {
            ...
            {
                formatter.AppendCodeLine(1, LoggingFormatter.InjectLoggingSyntax(LogLevel.Error, "The following unhandled exception occurred, see exception details. Throwing a unhandled managed exception.","unhandledException"));
